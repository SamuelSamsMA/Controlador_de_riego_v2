...
# 91 "./LCD_4x20.h"
void LCD_enviarByte(char dato, _Bool comando);
# 105 "./LCD_4x20.h"
void LCD_enviarNibble(char nib);

void cadenaTxt_LCD(char* cad);
# 2 "main.c" 2
    ...
    while (1) {
        ...
        case 12:
            if (fila_i > 1) {
                fila_i--;
                switch (fila_i) {
                case 1: LCD_enviarByte(0x80 | (0x00 + col_i - 1),1); break;
                case 2: LCD_enviarByte(0x80 | (0x40 + col_i - 1),1); break;
                case 3: LCD_enviarByte(0x80 | (0x14 + col_i - 1),1); break;
                case 4: LCD_enviarByte(0x80 | (0x54 + col_i - 1),1); break;
                }
            }
            break;
        ...
        case 18:
            LCD_enviarByte(0x01,1); _delay((unsigned long)((2)*(16000000/4000.0)));
            fila_i = 1;
            col_i = 1;
            break;
